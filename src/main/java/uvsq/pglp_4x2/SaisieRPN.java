...
public class SaisieRPN {
	 ...
	 */
	public String scanneLigne() throws IllegalArgumentException, MinMaxException, 
	ArgumentPileException {
		String input;
		if (sc.hasNextDouble()) {
	 ...
	 */
	public void isStackValid() throws IllegalArgumentException {
		if (!(this.moteur.getSizePile() == 1)) {throw new IllegalArgumentException();}
	}
